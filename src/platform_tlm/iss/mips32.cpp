...
void Mips32Iss::handle_exception()
{
    ...
    case X_INT:
        ex_class = EXCL_IRQ;
        std::cout << "EXCL_IRQ" << std::endl;
        break;
    case X_SYS:
        ex_class = EXCL_SYSCALL;
        std::cout << "EXCL_SYSCALL" << std::endl;
        break;
    case X_BP:
    case X_TR:
        ex_class = EXCL_TRAP;
        std::cout << "EXCL_TRAP" << std::endl;
        break;
    ...
    case X_TLBS:
        ...
        std::cout << "EXCA_PAGEFAULT" << std::endl;
        break;
    case X_ADEL:
    case X_ADES:
        ex_cause = EXCA_ALIGN;
        std::cout << "EXCA_ALIGN" << std::endl;
        break;
    case X_IBE:
    case X_DBE:
        ex_cause = EXCA_BADADDR;
        std::cout << "EXCA_BADADDR" << std::endl;
        break;
    case X_RI:
    case X_CPU:
        ex_cause = EXCA_ILL;
        std::cout << "EXCA_ILL" << std::endl;
        break;
    case X_OV:
    case X_FPE:
        ex_cause = EXCA_FPU;
        std::cout << "EXCA_FPU" << std::endl;
        break;
