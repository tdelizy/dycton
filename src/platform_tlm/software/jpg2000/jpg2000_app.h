...
#if 0
// base dataset
#define JPG2000_IN_FILE_PATH	"../software/jpg2000/input_base_4CIF.pnm"
#define JPG2000_IN_FILE_SZ		(1216527) // bytes
#define JPG2000_OUT_FILE_PATH	"../software/jpg2000/output_base_4CIF_96bps.jp2"
#define JPG2000_OUT_FILE_SZ		(12649) // bytes
#endif

// small dataset
#define JPG2000_IN_FILE_PATH	"../software/jpg2000/input_small.pnm"
#define JPG2000_IN_FILE_SZ		(76086) // bytes
#define JPG2000_OUT_FILE_PATH	"../software/jpg2000/output_small.jp2"
